...
DEFAULT_BRIEF = """Бренд-брифінг:
Ми — бренд преміальної української горілки "Воля" (Volya Vodka), яка виготовляється за унікальною технологією очищення сріблом. Ми орієнтуємося на сучасних, цинічних міських професіоналів у Києві (вік 25-45 років), які підтримують вітчизняні ініціативи, але втомилися від банальної благодійної реклами.

Вимоги до кампанії:
1. HoReCa: Потрібні нестандартні фізичні активації у топ-барах Києва (наприклад, барні зони на вулицях Ярославів Вал та Шота Руставелі). Ми хочемо розмістити преміальні композитні панелі (composite panels) на входах до закладів, де зображені тварини з притулку "Happy Paw" у стилі високої моди. Також потрібні фірмові коктейлі та брендовані LED-підставки для пляшок на барних стійках.
2. Digital: Локальна геотаргетована реклама навколо популярних барних вулиць та бізнес-центрів Києва. Спеціальний закритий Telegram-канал або бот для збору донатів без зайвого пафосу.
3. Retail: Інсталяції POS у мережах Goodwine та Bad Boy — брендовані торцеві стенди (POS displays) та фірмові композитні панелі.
4. CSR Інтеграція: Пряма фінансова допомога притулку "Happy Paw" на закупівлю зимових будок та обігрівачів для собак. Інтеграція має бути вишуканою та спонукати до дії, без банального тиску на жалість.
5. Бюджет: Загальний бюджет становить 1,500,000 грн. Надайте відсотковий розподіл та KPI для кожного каналу.
"""
